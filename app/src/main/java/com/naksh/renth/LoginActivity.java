...
//import com.google.firebase.database.FirebaseDatabase;
//import com.google.firebase.database.ValueEventListener;
//import com.naksh.renth.databinding.ActivityLoginBinding;
//import com.naksh.renth.databinding.ActivityLoginScreenBinding;
//
//import android.content.Context;
//import android.content.SharedPreferences;
...
//                } else {
//                    // Email not found in OwnerPersonalDetailsActivity node
//                    Toast.makeText(LoginActivity.this, "Owner data not found", Toast.LENGTH_SHORT).show();
//                }
//            }
//
//
...
//            @Override
//            public void onClick(View v) {
//                Intent loginIntent = new Intent(LoginActivity.this, SignUpScreen.class);
//                startActivity(loginIntent);
//            }
//        });
//
...
//                int selectedId = binding.person.getCheckedRadioButtonId();
//                if (selectedId == -1) {
//                    Toast.makeText(LoginActivity.this, "Please select a category", Toast.LENGTH_SHORT).show();
//                    return; // Return without attempting to sign in if no category is selected
//                }
//
//                // Getting the selected radio button and user type
...
//                                                String userType = selectedRadioButton.getText().toString();
//                                                Toast.makeText(LoginActivity.this, userTypeFromDatabase + " " + userType, Toast.LENGTH_SHORT).show();
//
//                                                if (userType.equals(userTypeFromDatabase)) {
//                                                    Intent intent = new Intent(LoginActivity.this, OwnerHomeActivity.class);
//                                                    intent.putExtra("user_id", userId);
...
//
//                                                if (userType.equals(userTypeFromDatabase)) {
//                                                    Intent intent = new Intent(LoginActivity.this, PropertyRecyclerActivityForUser.class);
//                                                    intent.putExtra("user_id", userId);
//                                                    intent.putExtra("notification_message", notificationMessage);
//                                                    intent.putExtra("id", ownerId);
//                                                    intent.putExtra("userName", userName);
...
//
//                                                    Toast.makeText(LoginActivity.this, "userEmail in login screen="+userEmail, Toast.LENGTH_LONG).show();
...
//                        } else {
//                            // Email not found in UserPersonalDetails node
//                            Toast.makeText(LoginActivity.this, "userId is null", Toast.LENGTH_SHORT).show();
//                        }
//                    }
//                } else {
